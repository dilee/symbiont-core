...
class DifferentiableCompiler:
    ...
    def compile(
        self, constraints: list["Constraint"], loss_type: str = "violation"
    ) -> "ConstraintLoss":
        """
        ...
        return ConstraintLoss(differentiable_constraints, loss_type)
...
class ConstraintLoss(nn.Module):
    ...
    def __init__(
        self, constraints: list[DifferentiableConstraint], loss_type: str = "violation"
    ):
        super().__init__()
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if self.loss_type == "violation":
            ...
            return torch.tensor(1.0) - total_satisfaction
